...
*Figure source: [Wikipedia GeoJSON primitives](https://en.wikipedia.org/wiki/GeoJSON)*
...
*NOTE: Another extremely convenient feature of having features stored in dataframes is that they can be stored as a single RDS file.*
...
*NOTE: This data was sourced from the [U.S. Census](https://www.census.gov/geographies/mapping-files/time-series/geo/cartographic-boundary.html) originally.*
...
#### **2. Re-project the data into something more suitable for spatial analysis**
...
### **Practice 1. Open a shapefile in sf and create some simple plots**
